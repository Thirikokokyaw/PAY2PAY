...
export default function Help() {
  ...
  const faqs = [
    ...
    { q: "Is there a limit on remittance exchanges?", a: "Standard limits scale between 1,000 MMK and 5,000,000 MMK dynamically based on current pool liquidity levels." }
  ];
