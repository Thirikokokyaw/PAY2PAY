          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className={`space-y-6 relative before:absolute before:left-2.5 before:top-2 before:bottom-2 before:w-[1px] ${darkMode ? 'before:bg-slate-600/30' : 'before:bg-slate-300'}`}>
              ...
              <div className="flex gap-5 relative items-start group">
                ...
                <div>
                  <h4 className={`text-sm font-bold group-hover:text-amber-500 dark:group-hover:text-yellow-300 transition-colors ${darkMode ? 'text-white' : 'text-slate-900'}`}>Transfer Funds First</h4>
                  <p className={`text-xs mt-1.5 leading-relaxed ${darkMode ? 'text-slate-200' : 'text-slate-600'}`}>
                    Check our available liquidity assets below the exchange terminal. Open your native mobile wallet app and transfer funds directly to our verified official merchant account.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-5 relative items-start group">
                ...
                <div>
                  <h4 className={`text-sm font-bold group-hover:text-amber-500 dark:group-hover:text-yellow-300 transition-colors ${darkMode ? 'text-white' : 'text-slate-900'}`}>Fill Out the Exchange Form</h4>
                  <p className={`text-xs mt-1.5 leading-relaxed ${darkMode ? 'text-slate-200' : 'text-slate-600'}`}>
                    Head over to our dedicated **Exchange** panel tab and fill the form accurately with your transaction voucher details, sender numbers, and target receiving account.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-5 relative items-start group">
                ...
                <div>
                  <h4 className={`text-sm font-bold group-hover:text-amber-500 dark:group-hover:text-yellow-300 transition-colors ${darkMode ? 'text-white' : 'text-slate-900'}`}>Submit and Get Paid Within 10 Mins</h4>
                  <p className={`text-xs mt-1.5 leading-relaxed ${darkMode ? 'text-slate-200' : 'text-slate-600'}`}>
                    Click execute. Our administrative system cross-checks the last 6 digits of your transaction reference and securely dispatches the swapped money to your destination account.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className={`border rounded-2xl p-5 flex flex-col justify-center shadow-inner ${darkMode ? 'bg-slate-950/60 border-slate-800/60' : 'bg-slate-100 border-slate-200'}`}>
              ...
              <div className="w-full aspect-video rounded-xl overflow-hidden bg-slate-950 border border-slate-800 relative shadow-2xl">
                <iframe 
                  ...
                  src="https://www.youtube.com/embed/MJIFV9E6vuE?autoplay=0&controls=1"
