...
export default function Pay2PayExchange() {
  ...
  const [userTransactions, setUserTransactions] = useState([
    { id: "TXN-8801", date: "Today, 02:30 PM", from: "Wave Pay", to: "KBZPay", amount: 50000, status: "Success" },
    { id: "TXN-8794", date: "Yesterday", from: "KBZPay", to: "Wave Pay", amount: 20000, status: "Pending" }
  ]);
  ...
  const handleLoginSuccess = (role, parsedUserData) => {
    ...
    if (parsedUserData) {
      setUserInfo({
        ...
        phone: parsedUserData.phone || "09xxxxxxxxx",
        avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&q=80"
      });
    }
        ...
        <main className={`w-full flex-grow flex flex-col justify-center ${activeView === 'home' ? 'px-0 py-0' : 'max-w-6xl mx-auto px-4 py-8'}`}>
          ...
          {activeView === 'exchange' && (
            <ExchangeFormPage 
              ...
              onTransactionSubmit={(txn) => setUserTransactions((prev) => [...prev, txn])}
