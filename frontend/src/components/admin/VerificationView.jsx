...
import { Check, X, Bell } from 'lucide-react'; // Imported Bell icon for notifications
...
export default function VerificationView({ theme, transactions, setTransactions }) {
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      {/* Header section: Uses flex, justify-between, and items-center to align title and notification bell */}
      <div className="flex justify-between items-center">
        <h2 className={`text-xl font-extrabold uppercase ${theme.textTitle}`}>Voucher Auditing Desk</h2>
        
        {/* Notification Bell Button with hover transitions */}
